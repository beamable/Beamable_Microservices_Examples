...
namespace Beamable.Server.Clients
{
    ...
    public sealed class MyCurrencyMicroserviceClient : MicroserviceClient
    {
        
        public MyCurrencyMicroserviceClient(BeamContext context = null) : 
                base(context)
        {
        }
    ...
    internal sealed class MicroserviceParametersMyCurrencyMicroserviceClient
    {
    }
    
    [BeamContextSystemAttribute()]
    internal static class ExtensionsForMyCurrencyMicroserviceClient
    {
        
        [Beamable.Common.Dependencies.RegisterBeamableDependenciesAttribute()]
        public static void RegisterService(Beamable.Common.Dependencies.IDependencyBuilder builder)
        {
            builder.AddScoped<MyCurrencyMicroserviceClient>();
        }
        
        public static MyCurrencyMicroserviceClient MyCurrencyMicroservice(this Beamable.Server.MicroserviceClients clients)
        {
            return clients.GetClient<MyCurrencyMicroserviceClient>();
        }
    }
}
